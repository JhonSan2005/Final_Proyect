    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 text-center text-md-start mb-3 mb-md-0">
                <h5 class="text-uppercase mb-3">Repuestos JJ</h5>
                <p>Proporcionamos repuestos de alta calidad para motocicletas. Tu satisfacción es nuestra prioridad.</p>
                <p>&copy; 2024 Repuestos JJ. Todos los derechos reservados.</p>
            </div>
