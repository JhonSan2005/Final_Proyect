...
('Filtro de Aire', 55.00, 16.00, 27, 2, 'Filtro maxima capacidad Cortina Plana', '/img/uploads/4.png'),
('Bujia Iridum', 80.00, 16.00, 30, 2, 'Bujia Mejorada optimo rendimiento', '/img/uploads/5.png'),
('Cadena KMC', 57.00, 16.00, 30, 2, 'Cadena de Cricton-Fi', '/img/uploads/6.png'),
('Llantas FZL6', 250.00, 16.00, 30, 3, 'Diseñadas para brindar un agarre superior y una conducción suave', '/img/uploads/7.png'),
('Llantas XTZ125', 239.00, 16.00, 30, 3, 'Perfectas para los terreno mas ostiles', '/img/uploads/8.png'),
('Llantas NKD-125', 200.00, 16.00, 30, 3, 'Te brindan comodidad para tu dia a dia conduccion suave', '/img/uploads/9.png');
